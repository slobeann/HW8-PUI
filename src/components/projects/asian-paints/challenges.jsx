  ...
  return (
    <div className="">
      <Container>
        ...
        <ContentWithImg
          image={
            <StaticImage src="../../../images/projects/asian-paints/design-3.png" alt="Graphic explaining the UI for order summary cards" />
          }
        >
        ...
        <ContentWithImg
          image={
            <StaticImage src="../../../images/projects/asian-paints/design-4.png" alt ="Card design for showing customized orders by previous customers"/>
          }
        >
          <p className="p3 font-semibold mb-6">
        ...
        <ContentWithImg
          image={
            <StaticImage src="../../../images/projects/asian-paints/design-5.png" alt="Context specific FAQ in the order summary section" />
          }
        >
          <p className="p3 font-semibold mb-6">
        ...
        <ContentWithImg
          image={
            <StaticImage src="../../../images/projects/asian-paints/design-6.png" alt= "UI design for premium product pages"/>
          }
        >
          <p className="p3 font-semibold mb-6">
        ...
        <ContentWithImg
          image={
            <StaticImage src="../../../images/projects/asian-paints/design-7.png" alt ="box diagram for the home page break up"/>
          }
        >
          <p className="p3 font-semibold mb-6">
